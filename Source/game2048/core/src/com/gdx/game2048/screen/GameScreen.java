...
public class GameScreen extends AbstractScreen implements InputProcessor {
    ...
    //Animation constant
    public static final int BASE_ANIMATION_TIME = 50;
    ...
    //THe code implement touch function
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        lastDy = 0;
        hasMoved = false;
        beganOnGrid = rectanglePressed(gridRect);
    ...
    private boolean rectanglePressed(Rectangle rect) {
        return inRange(rect.x, x, rect.x + rect.width) && inRange(rect.y, y, rect.y + rect.height);
    }
